...
class SudsClientTestCase(TestCase):
    ...
    def setUp(self):
        self.wsdl = 'file://' + os.path.realpath(os.path.dirname(
            os.path.realpath(
                __file__)) + '/../../../../mamba/tests/mamba/data/dummy.wsdl')
...
class SudsClientInitTest(SudsClientTestCase):
    ...
    def test_options_if_options_are_given(self):
        ...
        self.assertEqual({"Accept-Encoding": "gzip"},
                         suds_client.options.transport.options.headers)
...
class SudsClientGetLastRequestTest(SudsClientTestCase):
    ...
    def test_return_last_request(self):
        self.assertEqual(self.mock_last_request(),
                         self.client.get_last_request())
...
class SudsClientGetLastResponseTest(SudsClientTestCase):
    ...
    def test_return_last_response(self):
        self.assertEqual(self.mock_last_response(),
